...
const ItemsRoutes = [
  getItem("Inventario", "sub6", <AppstoreOutlined />, [
    ...
    getItem("Cargar Inventario", "22", <EyeOutlined />),
  ]),
  // getItem("Ordenes", "sub11", <AppstoreOutlined />, [
  //   getItem("nueva Orden", "20", <PlusCircleOutlined />),
  //   getItem("Lista Ordenes", "21", <EyeOutlined />),
  // ]),
  getItem("Farmacias", "sub7", <AppstoreOutlined />, [
    // getItem("Crear Farmacia", "12", <PlusCircleOutlined />),
    getItem("Lista Farmacia", "13", <UnorderedListOutlined />),
  ]),
